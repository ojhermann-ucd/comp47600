...
# input variables
wc_input = "This is my text.  It contains about fourty words, of which I expect roughly half to be excluded as stop words.  If I modified the input of the R command, I could change the results. I will repeat two words: donkey, donkey, donkey and is is is."
wc_output = "words donkey"
